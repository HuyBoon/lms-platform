...
-- AddForeignKey
ALTER TABLE "SubmissionDetail" ADD CONSTRAINT "SubmissionDetail_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "Question"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SubmissionDetail" ADD CONSTRAINT "SubmissionDetail_selectedAnswerId_fkey" FOREIGN KEY ("selectedAnswerId") REFERENCES "Answer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
