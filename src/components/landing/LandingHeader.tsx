    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b-8 border-primary/20 bg-background/80 backdrop-blur-xl">
            <div className="container mx-auto px-6 h-24 flex items-center justify-between">
                <Link
                    href="/"
                    className="flex items-center gap-4 group cursor-pointer bouncy-hover"
                >
                    ...
                    <span className="text-3xl font-black tracking-tight uppercase italic text-foreground flex flex-col leading-none">
                        <span className="text-sm not-italic tracking-[0.3em] text-slate-400 mb-1">
                            HUYBOON
                        </span>
                ...
                <nav className="hidden lg:flex items-center gap-2">
                    {[
                        ...
                        },
                        {
                            name: "Lớp học",
                            href: "#about",
                            color: "hover:bg-secondary/10 hover:text-secondary",
                        },
                        {
                            name: "Sáng tạo",
                            href: "#enterprise",
                        ...
                        <>
                            ...
                            <Link
                                ...
                                className={cn(
                                    ...
                                    "bouncy-hover rounded-2xl h-14 px-8 italic shadow-[4px_4px_0px_0px_#B89600] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]",
                                )}
                            >
                                Góc học tập
                            </Link>
                        ...
                        <>
                            <Link
                                ...
                                className={cn(
                                    ...
                                    "font-black bouncy-hover h-14 px-8 uppercase tracking-widest text-slate-500",
                                )}
                            >
                                Đăng nhập
                            </Link>
                            <Link
                                ...
                                className={cn(
                                    ...
                                    "bouncy-hover rounded-2xl h-14 px-10 italic shadow-[6px_6px_0px_0px_#B89600] active:shadow-none active:translate-x-[4px] active:translate-y-[4px] font-black uppercase tracking-widest",
                                )}
                            >
                                Tham gia ngay!
                            </Link>
